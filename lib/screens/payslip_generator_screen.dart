              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow('Employee ID:', 'HF-2025-009'),
                    _buildInfoRow('Position:', 'Senior Flutter Developer'),
                    _buildInfoRow('Department:', 'Product Engineering'),
                    _buildInfoRow('Email:', 'kkamlesh286@gmail.com'),
                    _buildInfoRow('Bank A/C:', 'DE89 3704 0044 0532 0130 00'),
                    _buildInfoRow('Tax ID:', 'DE-XX-XXXX'),
                  ],
                ),
              ),
            ),
